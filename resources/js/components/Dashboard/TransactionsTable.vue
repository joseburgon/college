            ...
            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                ...
                >{{ transaction.attributes.status }}</span>
                        ...
                        <td class="px-6 py-4 text-sm font-medium whitespace-no-wrap border-b border-gray-200">
                            {{ transaction.attributes.student_name.toUpperCase() }}
                        </td>

                        <td class="px-6 py-4 text-sm whitespace-no-wrap border-b border-gray-200">
                            {{ transaction.attributes.student_email }}
                        </td>
