            ...
            <div class="flex-col">
                <div class="flex flex-wrap md:6">
                    <div class="flex w-full md:w-1/2">
                            ...
                            <div class="flex-col justify-center pb-6">
                                <FormulateInput
                                    ...
                                    :validation-messages="{
                                        ...
                                        email:
                                            'Tu correo debe ser un email válido',
                                    }"
                            ...
                            <div class="grid grid-flow-col grid-cols-2 gap-4">
                                ...
                                <FormulateInput
                                    ...
                                    :validation-messages="{
                                        ...
                                        number:
                                            'Tu teléfono debe ser un número',
                                    }"
                                    outer-class="formulate-input flex-grow pl-2"
                                    label-class="text-xs font-bold"
                                    :disabled="registered"
                        ...
                        <div
                            v-show="registered"
                            class="payment-option w-full px-4 mt-6"
                        >
                            ...
                            >
                                <div class="p-8 text-center">
                                    ...
                                    >
                                        PSE &bull; BANCA EN LÍNEA<br />TARJETAS
                                        DE CRÉDITO<br />EFECTY &bull; BALOTO
                                    </p>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    TARJETA DE CR&Eacute;DITO INTERNACIONAL
                                </p>
                                <div
                                    id="paypal-button-container"
                                    class="px4 xl:px-20 py-8"
                                ></div>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <div
                            v-if="course.id"
                            class="flex flex-col flex-wrap py-4 px-8"
                        >
                            <div
...
export default {
    components: { PxHeader, PxPaymentMethods },
    data() {
        return {
