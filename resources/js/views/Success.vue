  ...
  <div class="w-full">
    <div class="flex bg-white sm:px-40 md:px-0" style="height:685px;">
      <div class="flex items-center text-center lg:text-left px-12 md:px-40 lg:w-1/2">
        <div>
          <h2 class="text-3xl font-semibold md:text-4xl">¡Compra completada!</h2>
          <p class="mt-2 text-sm text-gray-500 md:text-base">
            Con esto has quedado matriculado para el curso:
            <br />
            <span class="text-black font-semibold">De la carencia a la abundancia.</span>
      ...
      >
        <div class="h-full object-fit" style="background-image: url(/img/approved_banner.jpg)">
