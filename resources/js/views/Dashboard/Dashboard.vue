          ...
          <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
            ...
            >
              ...
              <div class="mx-5">
                ...
                <div class="text-gray-500">Registered Students</div>
              </div>
            </div>
          </div>
          ...
          <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
            ...
            >
              ...
              <div class="mx-5">
                ...
                <div class="text-gray-500">Available Courses</div>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    studentsCount() {
      return this.$store.state.studentsCount
    },
    ...
    transactionsCount() {
      return this.$store.state.transactionsCount
    },
  },
  created() {
  ...
  mounted() {
    ...
    this.$store.dispatch('countApprovedTransactions')
